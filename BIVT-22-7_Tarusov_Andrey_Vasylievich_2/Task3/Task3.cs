...
namespace Task3
{
    public class DataBase
    {
        ...
        static public bool? IsInBD(List<Student> students, Student student, bool inbd = false, int idStudent = 0)
        {
            if (inbd) 
            { 
                if (idStudent > 0 && idStudent < students.Count)
                {
            ...
            else
            {
                for (int i =0; i < students.Count; i++)
                {
                    if (students[i].fullName == student.fullName && student.birthdayDate.day ==stu)
                    {
                        return true;
                    }
                }
        ...
        static public void DeleteRep(List<Student>)
        { }
    }
    ...
    public class Task3
    {
        ...
        static int Menu()
        {
            List<DataBase.Student> studentList = new List<Student>();
            try
            {
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    ...
                    case "7":
                        ...
                        List<List<Student>> result = ListMinMaxStudents(studentList, MaxMin);
                    ...
                    case "help":
                        ...
                        Console.WriteLine("5 - Вывод всей бд на экран.");
