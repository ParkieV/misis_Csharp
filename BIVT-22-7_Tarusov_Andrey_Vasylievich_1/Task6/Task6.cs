namespace Task6
{
    ...
    public class TaskThird
    {
        ...
        static public void FindMinMax(int[][] mas)
        {
            ...
            Console.WriteLine($"Min: {minEl[0]} {minEl[1]} {minEl[2]}");
            Console.WriteLine($"Max: {maxEl[0]} {maxEl[1]} {maxEl[2]}");
        }
        ...
        static public int ChangeElement(int[][] mas, StreamReader? rstream)
        {
            int[] result = new int[2];
            string[] temp;
            Console.Write("Введите координаты элемента, который хотите изменить: ");
            if (rstream == null)
            {
                while (true)
                {
